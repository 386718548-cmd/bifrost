...
export interface LogEntry {
	...
	user_agent?: string; // Raw HTTP User-Agent of the calling client; mapped to a client app in the UI
}
...
export interface LogFilters {
	...
	user_agents?: string[]; // Raw User-Agent strings; the UI expands a selected client app to its matching UAs
}
...
export type RankingDimension = "team" | "customer" | "business_unit" | "user" | "user_agent";
